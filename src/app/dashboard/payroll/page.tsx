...
export default function PayrollDashboardPage() {
  ...
  if (loading && employees.length === 0) return <div className="p-8">Loading...</div>;

  return (
    <div className="space-y-6 max-w-7xl mx-auto pb-24 relative">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-zinc-900 dark:text-zinc-50">Payroll Dashboard</h1>
          <p className="text-zinc-500 dark:text-zinc-400">Manage, generate, and bulk pay employee salaries.</p>
        </div>
