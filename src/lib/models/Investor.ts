...
const InvestorSchema: Schema<IInvestor> = new Schema(
  {
    ...
    debentureForm: {
      ...
      officeReceivedOn: { type: String },
      officeReceivedBy: { type: String },
      officeAmountReceived: { type: Number },
      officePaymentMode: { type: String },
      officeRemark: { type: String },
      officeStatus: { type: String },
      officeAllottedNo: { type: String },
      verifiedName: { type: String },
      verifiedDesignation: { type: String },
      verifiedSignDate: { type: String },
      approvedName: { type: String },
      approvedDesignation: { type: String },
      approvedSignDate: { type: String },
    },
    nomineeName: { type: String },
    nomineeRelation: { type: String },
    nomineeAge: { type: String },
